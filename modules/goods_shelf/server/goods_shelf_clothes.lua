...
local GoodsShelfClothes = Lib.class("GoodsShelfClothes", GoodsShelfBase)

function GoodsShelfClothes:ctor(param)
  GoodsShelfBase.ctor(self, param)
  self._type = Define.GoodsShelf.Type.Clothes
  ...
  local cfgName = "myplugin/trigger_goods_shelf_clothes"
