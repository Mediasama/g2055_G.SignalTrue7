...
local GoodsShelfCar = Lib.class("GoodsShelfCar", GoodsShelfBase)

function GoodsShelfCar:ctor(param)
  GoodsShelfBase.ctor(self, param)
  self._type = Define.GoodsShelf.Type.Cars
  ...
  local cfgName = "myplugin/trigger_goods_shelf_car"
