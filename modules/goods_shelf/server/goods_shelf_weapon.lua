...
local GoodsShelfWeapon = Lib.class("GoodsShelfWeapon", GoodsShelfBase)

function GoodsShelfWeapon:ctor(param)
  GoodsShelfBase.ctor(self, param)
  self._type = Define.GoodsShelf.Type.Weapons
  ...
  local cfgName = "myplugin/trigger_goods_shelf_weapon"
