...
local GoodsShelfBullet = Lib.class("GoodsShelfBullet", GoodsShelfBase)

function GoodsShelfBullet:ctor(param)
  GoodsShelfBase.ctor(self, param)
  self._type = Define.GoodsShelf.Type.Bullet
  ...
  local cfgName = "myplugin/trigger_goods_shelf_bullet"
