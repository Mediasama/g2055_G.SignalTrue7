...
function ShortConfig:init()
  local csvData = Lib.read_csv_file(Root.Instance():getGamePath() .. "config/short.csv", 2)
  csvData = csvData or Lib.read_csv_file(Root.Instance():getGamePath() .. "modules/new_chat/csv/short.csv", 2) or {}
