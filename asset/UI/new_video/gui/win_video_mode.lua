...
local HANDLE_STATE = {DOWN_HANDLE_LIST = 1, UP_HANDLE_LIST = 2}
...
function M:initUI()
  ...
  self.messageView = widget_virtual_vert_list:init(self.ScrollableView, self.effectInfoList, function(self, parentWindow)
...
function M:initEvent()
  function self.btnVideoModeExitBtn.onMouseClick()
    self:close()
  end
  ...
  function self.lytVideoModeCloseEffect.onMouseClick()
    self:updateEffectViewShow()
  end
  
  function self.btnVideoModeEffectBtn.onMouseClick()
    local defaultData = {
      entrance = 0,
      filter = 1,
      hideUI = 0,
  ...
  function self.btnVideoModeHideUiBtn.onMouseClick()
    local defaultData = {
      entrance = 0,
      filter = 0,
      hideUI = 1,
    ...
    Me.joystickWin:hideOrShowUI(false)
    self:updateEffectListPanelShow(false)
  ...
  function self.btnVideoModeHideUiSettingBtn.onMouseClick()
    local defaultData = {
      entrance = 0,
      filter = 0,
      hideUI = 0,
  ...
  function self.btnVideoModeShowOrHideHandleListBtn.onMouseClick()
    ...
    if self.curHandleState == HANDLE_STATE.UP_HANDLE_LIST then
      ...
      Me.joystickWin:hideOrShowUI(true)
      local defaultData = {
        entrance = 0,
        filter = 0,
        hideUI = 0,
