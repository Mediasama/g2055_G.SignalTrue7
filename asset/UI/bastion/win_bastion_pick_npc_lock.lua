local WinBastionPickNpcLock = M

function WinBastionPickNpcLock:initUI()
...
function WinBastionPickNpcLock:initEvent()
...
function WinBastionPickNpcLock:initView(param)
  ...
  local size = Lib.copy(self.validArea:getSize())
...
function WinBastionPickNpcLock:getStatus()
  return self.status
end

function WinBastionPickNpcLock:setStatus(status)
...
function WinBastionPickNpcLock:tryPick()
...
function WinBastionPickNpcLock:cancelHack()
  local param = {type = "Cancel"}
  Me:ndp_C2S_RequestHackNpcDoor(param)
end

function WinBastionPickNpcLock:confirmHack()
  local param = {type = "Confirm"}
  Me:ndp_C2S_RequestHackNpcDoor(param)
end

function WinBastionPickNpcLock:updateCursor(frameTime)
...
function WinBastionPickNpcLock:updateProgress(frameTime)
...
function WinBastionPickNpcLock:onOpen(param)
  self.isValid = true
...
function WinBastionPickNpcLock:onClose()
