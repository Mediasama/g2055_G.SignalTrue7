...
local WinGoodsShelfArmory = M
local GridView = require("ui.widget.widget_virtual_grid")

function WinGoodsShelfArmory:initUI()
  ...
  self.clothesGridView = GridView:init(scrollView, contentView, function(gridView, parentWindow)
    local gridItem = UI:openWidget("./UI/goods_shelf/widget_goods_shelf_armory_item")
...
function WinGoodsShelfArmory:initEvent()
...
function WinGoodsShelfArmory:initView(param)
...
function WinGoodsShelfArmory:getGoodsArray()
...
function WinGoodsShelfArmory:getSelectGoodsItem()
  local itemArray = self:getGoodsArray()
  local item = itemArray[self.selectIndex]
  return item
end

function WinGoodsShelfArmory:updateView(reload)
  local itemArray = self:getGoodsArray()
  if reload then
...
function WinGoodsShelfArmory:onClothesItemClicked(index)
...
function WinGoodsShelfArmory:requestPurchase()
  local selectItem = self:getSelectGoodsItem()
  ...
  param.type = Define.GoodsShelf.Type.Weapons
...
function WinGoodsShelfArmory:onOpen(param)
  self.isValid = true
...
function WinGoodsShelfArmory:onClose()
  self.isValid = false
