...
M.PanelState = {FriendApply = 1, FriendList = 2}
...
function M:initUI()
  ...
  self.friendTitleItemList[Define.chatFriendType.apply] = UI:openWidget("./UI/new_chat/gui/widget_chat_friend_title_apply", nil, Define.chatFriendType.apply)
  verticalLayout:addChild(self.friendTitleItemList[Define.chatFriendType.apply])
  self.friendTitleItemList[Define.chatFriendType.game] = UI:openWidget("./UI/new_chat/gui/widget_chat_friend_title_normal", nil, Define.chatFriendType.game)
  verticalLayout:addChild(self.friendTitleItemList[Define.chatFriendType.game])
  self.friendTitleItemList[Define.chatFriendType.platform] = UI:openWidget("./UI/new_chat/gui/widget_chat_friend_title_normal", nil, Define.chatFriendType.platform)
  ...
  self.applyListView = widget_virtual_vert_list:init(self.scrollView, self.scrollView.VerticalLayout, function(self, parentWindow)
